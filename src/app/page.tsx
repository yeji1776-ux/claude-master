  ...
  return (
    <div className="min-h-dvh">
      ...
      <button
        ...
        className="fixed top-4 right-4 z-40 w-10 h-10 flex items-center justify-center bg-white/70 backdrop-blur-xl border border-white/80 rounded-full shadow-lg shadow-black/5 text-gray-500 hover:text-amber-600 hover:bg-white/90 transition-all"
        aria-label="검색"
      >
